    ...
    <form action="${pageContext.request.contextPath}/save" class="form-horizontal" method="POST"
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <div ng-init="phones = [<c:forEach items="${person.getPersonalInfo().getPhones()}">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="tel" name="phone[0]" ng-model="_phone[0]" required
                                   placeholder="e.g. +421914868497">
                            </br>
                            <div ng-repeat="phone in phones">
                                <input class="form-control" type="tel" name="phone[{{$index + 1}}]"
                ...
                <div class="form-group">
                    <div ng-init="emails = [ <c:forEach items="${person.getPersonalInfo().getEmails()}">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="email" name="email[0]" ng-model="_email[0]" required
                                   placeholder="e.g. default@gmail.com">
                            </br>
                            <div ng-repeat="email in emails">
                                <input class="form-control" type="email" name="email[{{$index + 1}}]"
        ...
        <div class="row">
            ...
            <div ng-init="schools = [ [], <c:forEach items="${person.getEducation()}">
                ...
                <div ng-repeat="school in schools" class="row">
                    ...
                    <div class="col-md-3">
                        <input class="form-control" type="text" name="e_fieldOfStudy[{{$index}}]" ng-model="_e_fieldOfStudy[ $index ]"
                               placeholder="e.g. Informatics">
                    </div>
                    <div class="col-md-2">
                        <input class="form-control" type="text" name="e_since[{{$index}}]" ng-model="_e_since[ $index ]"
            ...
            <div ng-repeat="company in companies" class="row">
                ...
                <div class="col-md-3">
                    <input class="form-control" type="text" name="c_nameC[{{$index}}]" ng-model="_c_nameC[ $index ]"
                           placeholder="e.g. Monitor s.r.o.">
                </div>
                <div class="col-md-3">
                    <input class="form-control" type="text" name="c_position[{{$index}}]" ng-model="_c_position[ $index ]"
                           placeholder="e.g. tester">
                </div>
                <div class="col-md-2">
                    <input class="form-control" type="text" name="c_sinceC[{{$index}}]" ng-model="_c_sinceC[ $index ]"
                           placeholder="e.g. 1.1.2011">
                </div>
                <div class="col-md-2">
        ...
        <div class="row">
            <div id="languages " class="col-md-5">
                ...
                <div ng-repeat="language in languages" class="row">
                    ...
                    <div class="col-md-7">
                        <input class="form-control" type="text" name="l_language[{{$index}}]" ng-model="_l_language[$index]"
                ...
                <div ng-init="hobbies = [ [], <c:forEach items="${person.getHobbies()}">
                    ...
                    <div class="col-md-12">
                        <div ng-repeat="hobby in hobbies" class="row">
                            ...
                            <input class="form-control" type="text" name="hobbies[{{$index}}]" ng-model="_c_hobbies[$index]"
        ...
        <div class="row">
            <form action="${pageContext.request.contextPath}/download" method="POST">
                <input type="hidden" name="login" value="<c:out value="${person.getUserLogin()}"/>">
                <input type="hidden" name="pdfLang" value="cz">
                <div class="col-md-6">
                    <button type="submit" class="btn btn-primary btn-lg btn-block">Download pdf in CZ</button>
                </div>
            </form>
            <form action="${pageContext.request.contextPath}/download" method="POST">
                <input type="hidden" name="login" value="<c:out value="${person.getUserLogin()}"/>">
                <input type="hidden" name="pdfLang" value="en">
                <div class="col-md-6">
                    <button type="submit" class="btn btn-primary btn-lg btn-block">Download pdf in EN</button>
                </div>
            </form>
